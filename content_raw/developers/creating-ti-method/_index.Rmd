...
- [**Directly through R**](create_ti_method_barebones): Using R packages as dependencies, and using R to read in the data, infer the trajectory and return a trajectory model. This has the least overhead, although you're restricted to R.
