...
titles <- ggplot() + geom_text(aes(x=1, y = 0.5, label = "Color")) + geom_text(aes(x=0.5, y = 0, label = "Position")) + geom_segment(aes(x=0.2, y=0.8, xend=1, yend=0), color = "#666666") + theme_void() + scale_x_continuous(limits = c(0, 1)) + scale_y_continuous(limits = c(0, 1))
title <- list(
  titles, 
