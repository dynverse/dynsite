...
* A dataset, wrapped using `dynwrap::wrap_data`
...
Often it is useful to run multiple methods and/or use multiple datasets. While you easily parallelise this yourself, we provide a helper function for this: `dynwrap::infer_trajectories()`. This function integrates well with future interpretation and plotting functions.
