...
This tutorial quickly guides you through the main steps in the dyno workflow. For each step, we also provide a more in-depth tutorial in the [workflow](../3-workflow) section.
...
[➽ An in-depth tutorial for preparing your data](../3-workflow/1-preparing)
...
[➽ An in-depth tutorial for selecting the most optimal set of methods](../3-workflow/2-guidelines)
...
Let's first quickly plot the results so that we get an idea of how the trajectory looks like.

```{r}
plot_dimred(model)
```

[➽ An in-depth tutorial for running the methods](../3-workflow/3-running)
...
[➽ An in-depth tutorial for visualising the models](../3-workflow/4-visualisation)
...
[➽ An in-depth tutorial for adapting the trajectory](../3-workflow/5-adapting)
...
[➽ An in-depth tutorial for finding trajectory differentially expressed genes](../3-workflow/6-tde)
